...
- (void)selectedClicked:(UIButton *)btn {
    ...
    if ([self.delegate respondsToSelector:@selector(nodeTableViewCellSelected:atIndexPath:)]) {
        [self.delegate nodeTableViewCellSelected:self.selected atIndexPath:self.cellIndexPath];
    }
}
...
- (void)expandBtnClicked:(UIButton *)btn {
    ...
    if ([self.delegate respondsToSelector:@selector(nodeTableViewCellExpand:atIndexPath:)]) {
        [self.delegate nodeTableViewCellExpand:self.expand atIndexPath:self.cellIndexPath];
    }
}
